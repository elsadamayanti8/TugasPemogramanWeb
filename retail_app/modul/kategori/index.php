            ...
            <div class="modal-header">
                ...
                <form action="modul/kategori/proses.php?aksi=tambah" method="POST">
                    <div class="modal-body">
                        ...
                        <input class="form-control" type="text" name="namakategori" placeholder="Masukan nama kategori" required>
                    </div>
                    <div class="mb-3">
                        ...
                        <div class="modal-content">
                            ...
                            <form action="modul/kategori/proses.php?aksi=edit&id=<?= $row_kategori['id_kategori']; ?>" method="POST">
                                <div class="modal-body">
                                    <div class="mb-3">
                                        <label class="form-label" for="namakategori">Nama Kategori</label>
                                        <input class="form-control" type="text" name="namakategori" placeholder="Masukan nama kategori" value="<?= $row_kategori['nama_kategori']; ?>" required>
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label" for="status">Status</label>
                                        <select class="form-select" name="status">
