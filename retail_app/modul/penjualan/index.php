...
<div class="row justify-content-center mt-3">
    <div class="col-7 bg-secondary-subtle me-3 p-3 shadow-sm">
        ...
        <div class="d-flex justify-content-end">
            ...
            <button class="btn btn-primary" type="button" data-bs-toggle="modal" data-bs-target="#modalBayar">Bayar</button>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <button class="btn btn-primary" type="button" onclick="simpanPenjualan()">Proses</button>
                        </div>
                    </div>
                </div>
             </div>
    ...
    <div class="col-4 bg-secondary-subtle p-3 shadow-sm">
        <div class="mb-3">
        ...
        <div class="mb-3">
            <button class="btn btn-primary w-100" type="button" onclick="tambahItem()">Tambah Item</button>
        </div>
    </div>
</div>
            ...
            <tbody>
                ...
                while($row_penjualan = $result_penjualan->fetch_assoc()) {
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="?modul=penjualan&aksi=detail&id=<?= $row_penjualan['id_penjualan'];?>" class="btn btn-primary btn-sm">
